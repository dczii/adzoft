    ...
    return (
        <Grid container className='about-component' justify='center'>
            ...
            <Container>
                ...
                <Grid item xs={12} className='display-center'>
                    <ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
                        <h1><Icon path={mdiRhombus} size={1} color='white' /> Our Mission <Icon path={mdiRhombus} size={1} color='white' /></h1>
                    </ScrollAnimation>
                    <ScrollAnimation animateIn="fadeInLeft" animateOut="fadeOutRight">
                ...
                <Grid item xs={12} className='display-center'>
                    <ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
                        <h1><Icon path={mdiRhombus} size={1} color='white' /> Our Vision <Icon path={mdiRhombus} size={1} color='white' /></h1>
                    </ScrollAnimation>
                    <ScrollAnimation animateIn="fadeInLeft" animateOut="fadeOutRight">
                ...
                <Grid item xs={12} className='display-center'>
                    <ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
                        <h1><Icon path={mdiRhombus} size={1} color='white' /> Our Impact <Icon path={mdiRhombus} size={1} color='white' /></h1>
                    </ScrollAnimation>
                    <ScrollAnimation animateIn="fadeInLeft" animateOut="fadeOutRight">
